...
* **Multi-Modal POC Projects:** 
  * *Digital Pathology (SSL):* Built a proof-of-concept for a client using Self-Supervised Learning (SSL); mapped ultra-high-resolution histopathological scans (**50k x 50k pixels**) using windowing to generate patch-level embeddings for drug effectiveness classification.
